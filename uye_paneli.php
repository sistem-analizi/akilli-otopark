...
if(isset($_POST['rezervasyon_yap'])) {
    ...
    // YENİ DİNAMİK FİYAT ALGORİTMASI (Arka Plan)
    if($yuz >= 25 && $yuz < 50) $h_fiyat = $taban * 1.25;
    elseif($yuz >= 50 && $yuz < 75) $h_fiyat = $taban * 1.5;
    elseif($yuz >= 75) $h_fiyat = $taban * 2;
    
    $h_fiyat = round($h_fiyat);
    $toplam_tutar = $sure * $h_fiyat;
...
// YENİ DİNAMİK FİYAT ALGORİTMASI (Arayüz İçin)
$t_fiyat = isset($ayarlar['taban_fiyat']) ? (int)$ayarlar['taban_fiyat'] : 50;
$y_doluluk = ($g_dolu / 4) * 100;
$g_saatlik = $t_fiyat;

if($y_doluluk >= 25 && $y_doluluk < 50) $g_saatlik = $t_fiyat * 1.25;
elseif($y_doluluk >= 50 && $y_doluluk < 75) $g_saatlik = $t_fiyat * 1.5;
elseif($y_doluluk >= 75) $g_saatlik = $t_fiyat * 2;
